...
import { ADDRESS, AS, ASSIGN, BREAK, CONTINUE, DECLARATION, DEFAULT_MEMORY, DEFAULT_TABLE, DEFINITION, ELSE, EXPORT, FN, FN_PTR, FN_SIGNATURE, FROM, IF, IMMUTABLE, IMPORT, INIT_EXPR, LOOP, NEG, PARAM_LIST, PTR, RETURN, ROOT, STORAGE_TYPE, STRING, SUFFIX_OP, TYPE_LIST, VALUE_TYPE, VARIABLE, VOID, YIELD } from "../compiler/syntax.js";
