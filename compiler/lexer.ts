import { ADD, ADDRESS, ADDRESS_CLOSE, ALLOCATE_PAGES, AND, AS, ASSIGN, ASType, BAD_TOKEN, BITWISE_AND, BITWISE_OR, BITWISE_SHIFT, BITWISE_XOR, BLOCK, BLOCK_CLOSE, BREAK, CALL, COMMA, COMMENT, CONTINUE, DEFAULT_MEMORY, DEFAULT_TABLE, DEFINITION, ELEMENT, ELSE, END_OF_INPUT, EQ_COMPARISON, EXPORT, F32_LITERAL, F64_LITERAL, FN, FN_PTR, FROM, I32_LITERAL, I64_LITERAL, IF, IMMUTABLE, IMPORT, LOOP, MEMORY_ACCESS, MISC_INFIX, OR, ORDER_COMPARISON, PAGES_ALLOCATED, PAREN, PAREN_CLOSE, PTR, RETURN, SCALE_OP, SEMICOLON, STORAGE_TYPE, STRING, SUB, SUFFIX_OP, UNARY_MATH_OP, VALUE_TYPE, VARIABLE, VOID, WS, YIELD } from "./syntax.js";
